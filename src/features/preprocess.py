...
def preprocess(git_commits, szz_fault_inducing_commits, refactoring_miner, git_commits_changes):
	...
	fault_fixing_commits = refactoring_fault_inducing.merge(git_commits, left_on="FAULT_INDUCING_COMMIT_HASH", right_on="COMMIT_HASH")
	fault_fixing_commits = fault_fixing_commits.drop("COMMIT_HASH", axis=1)
	fault_fixing_commits = fault_fixing_commits.merge(git_commits_changes, left_on="FAULT_INDUCING_COMMIT_HASH", right_on="COMMIT_HASH")
	fault_fixing_commits = fault_fixing_commits.drop("COMMIT_HASH", axis=1)
